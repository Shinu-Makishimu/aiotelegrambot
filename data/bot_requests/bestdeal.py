...
async def hotels_start(message: types.Message):
    message_text = f'Вы выбрали поиск лучшего предложения по цене и радиусу от центра\n ' \
                   f'Внимание, бот понятия не имеет где центр города, поэтому расстояние от центра не точное!\n' \
